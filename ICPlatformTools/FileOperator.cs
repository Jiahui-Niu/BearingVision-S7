...
namespace ICPlatformTools
{
    public class FileOperator
    {
        ...
        /// <returns></returns>
        public static string GetAppConfigValue(string strFileName, string appKey)
        {
        ...
        public static void SetAppConfigValue(string strFileName, string Xkey, string Xvalue)
        {
            try
            {
                XmlDocument doc = new XmlDocument();
                doc.Load(@strFileName);
                XmlNode node = doc.SelectSingleNode(@"//add[@key='" + Xkey + "']");
        ...
        public static string ReadTextLine(string strFileName)
        {
            string strData = "";
            try
            {
        ...
        public static void WriteTextLine(string strFileName, string strData)
        {
            try
            {
                if (!System.IO.File.Exists(strFileName))
                ...
                {
                    FileStream fs = new FileStream(strFileName, FileMode.Truncate);
            ...
            {
                System.Diagnostics.Debug.Write(ex.Message);
                //MessageBox.Show(string.Format("FileOperator.WriteTextLine(string strFileName, string strData) error {0}", ex.Message));
            }
        }
